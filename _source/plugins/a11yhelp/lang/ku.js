...
CKEDITOR.plugins.setLang( 'a11yhelp', 'ku',
{
	accessibilityHelp :
	{
		title : 'ڕێنمای له‌به‌رده‌ستدابوون',
		contents : 'پێکهاته‌ی یارمه‌تی. کلیك ESC بۆ داخستنی ئه‌م دیالۆگه.',
		legend :
		[
			{
				name : 'گشتی',
				items :
						[
							{
								name : 'تووڵامرازی سه‌رنووسه‌ر',
								legend:
									'کلیك ${toolbarFocus} بۆ ڕابه‌ری تووڵامراز. بۆ گواستنه‌وه‌ی پێشوو داهاتووی گرووپی تووڵامرازی داگرتنی کلیلی TAB له‌گه‌ڵ‌ SHIFT-TAB. بۆ گواستنه‌وه‌ی پێشوو داهاتووی دووگمه‌ی تووڵامرازی له‌ڕێی کلیلی تیری ده‌ستی ڕاست یان کلیلی تیری ده‌ستی چه‌پ. کلیکی کلیلی SPACE یان ENTER بۆ چالاککردنی دووگمه‌ی تووڵامراز.' 
							},

							{
								name : 'دیالۆگی سه‌رنووسه‌ر',
								legend :
									'له‌هه‌مانکاتدا که‌تۆ له‌دیالۆگی, کلیکی کلیلی TAB بۆ ڕابه‌ری خانه‌ی دیالۆگێکی تر, داگرتنی کلیلی SHIFT + TAB بۆ گواستنه‌وه‌ی بۆ خانه‌ی پێشووتر, کلیكی کلیلی ENTER بۆ ڕازیکردنی دیالۆگه‌که, کلیكی کلیلی ESC بۆ هه‌ڵوه‌شاندنه‌وه‌ی دیالۆگه‌که. بۆ دیالۆگی له‌بازده‌ری (تابی) زیاتر, کلیكی کلیلی ALT + F10 بۆ ڕابه‌ری لیستی بازده‌ره‌کان. بۆ چوونه‌ بازده‌ری تابی داهاتوو کلیكی کلیلی TAB یان کلیلی تیری ده‌ستی ڕاست. بۆچوونه‌ بازده‌ری تابی پێشوو داگرتنی کلیلی SHIFT + TAB یان کلیلی تیری ده‌ستی چه‌پ. کلیی کلیلی SPACE یان ENTER بۆ هه‌ڵبژاردنی بازده‌ر (تاب).' 
							},
